...
public static String [] mPath(int a, int b, int c, int d) {
    String res = "";
    while (b > a) {
        if (b % c == 0) {
    ...
    String [] arrPath = res.split(" ");
    return arrPath; 
}
public static void printPath( String [] array) {
...
public static void main(String[] args) {
    ...
    if (res == 0 ) {
        ...
        System.out.println("Количество возможных путей из " +a+" в " +b+ ": "+ res);
        String [] arrPath = mPath(a, b, c, d);
        printPath(arrPath);
    }
}
}